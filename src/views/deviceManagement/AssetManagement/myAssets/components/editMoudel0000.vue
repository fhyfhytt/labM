      ...
      <el-row class="addtop">
        <el-col :span="8">
          <el-form-item label="资产编号:" prop="code">
            <el-input v-model="editForm.no" autocomplete="off" disabled />
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="操作编号" prop="assetCode">
            <el-input v-model="editForm.assetCode" autocomplete="off" disabled />
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="资产名称" prop="assetName">
            <el-input v-model="editForm.assetName" autocomplete="off" disabled />
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="资产分类" prop="itemType">
            <el-input v-model="editForm.itemType" autocomplete="off" disabled />
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="设备型号" prop="unitType">
            <el-input v-model="editForm.unitType" autocomplete="off" disabled />
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="设备厂商" prop="factory">
            <el-input v-model="editForm.factory" autocomplete="off" disabled />
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="数量" prop="num">
            <el-input v-model="editForm.num" autocomplete="off" disabled />
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="采购价（元）" prop="price">
            <el-input v-model="editForm.price" autocomplete="off" readonly />
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="资产状态" prop="states">
            <el-select v-model="editForm.states" value-key="name" popper-class="select-option" placeholder="-请选择库房状态-">
              <el-option v-for="item in statuesList" :key="item.code" :label="item.name" :value="item" />
            </el-select>
          </el-form-item>
        </el-col>
        <el-col :span="8">
        ...
        <el-col :span="8">
          <el-form-item label="分布位置" prop="location">
