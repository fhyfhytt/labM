        ...
        <div class="form-content">
          <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="100px" class="demo-ruleForm">
            ...
            <el-form-item label="原密码:" prop="oldpassword">
              <el-input v-model="ruleForm.oldpassword" name="oldpassword" type="password" autocomplete="off" placeholder="输入新密码" />
            </el-form-item>
            <el-form-item label="新密码:" prop="newpassword">
              <el-input v-model="ruleForm.newpassword" name="pass" type="password" autocomplete="off" placeholder="输入新密码" />
            </el-form-item>
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        oldpassword: [{ validator: validatePass4, trigger: 'blur' }],
  ...
  methods: {
    ...
    submitForm() {
      ...
      this.$refs.ruleForm.validate(valid => {
        if (valid) {
          updateLogin(param).then(response => {
            if (response.code === 0) {
