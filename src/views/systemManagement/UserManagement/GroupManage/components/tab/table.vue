<template>
  <div class="page-table-content">
    ...
    <el-table :data="tableDate" height="605" @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="code" label="班组编号" width="" />
      <el-table-column prop="name" label="班组名称" width="" />
      <el-table-column prop="type" :formatter="typeformatter" label="班组类型" />
    ...
    <!--编辑界面-->
    <el-dialog v-if="editFormVisible" v-model="editFormVisible" title="修改班组" :close-on-click-modal="false" :visible.sync="editFormVisible" :before-close="handleClose" class="deviceAdd addmanage">
