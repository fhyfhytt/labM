        ...
        <el-row>
          <el-col :span="24">
            <div class="right-page-title">
              <span style="margin-left:16px;margin-right:60px;"><span style="padding-right:10px;">班组编号:</span>{{ selectedCode }}</span>
              <span style="margin-right:100px;margin-left:40px;"><span style="padding-right:10px;">班组名称:</span>{{ selectedName }}</span>
...
export default {
  ...
  data() {
    return {
      ...
      // selectedCodeShow: false, // 班组编号是否显示
      tableManageParent: true, // 班组管理下父级管理中心是否显示
      // orgtype: '', // 区分是否是最后一级
      treedata: [], // tree树
